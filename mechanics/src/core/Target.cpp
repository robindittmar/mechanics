...
void CTarget::SetTarget(Vector& vAimPoint, QAngle& qAimAngles, IClientEntity* pEntity, float fViewAngleDist, float fOriginDist, int bIsBacktracked, float fDamage)
{
